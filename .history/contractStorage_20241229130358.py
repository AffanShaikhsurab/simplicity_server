...
class ContractStorageDb:
    ...
    def _serialize_symbol_table(self, symbol_table):
        """
        Convert symbol table to binary serialized format using pickle.
        """
    ...
    def _deserialize_symbol_table(self, binary_data):
        """
        Convert binary serialized format back to symbol table.
        """
        ...
        serialized_table = pickle.loads(binary_data)
