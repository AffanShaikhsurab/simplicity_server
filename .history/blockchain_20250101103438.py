...
class Blockchain:
    ...
    def execute_contract(self , transaction ,  public_address, digital_signature):
        ...
        try:
            ...
            contract_transaction = SmartContractTransaction(public_address , transaction['contract_address'] , transaction.get('parameters', None) ,public_address , digital_signature)
            self.current_transactions.append({
