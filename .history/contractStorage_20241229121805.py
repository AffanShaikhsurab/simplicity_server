...
class ContractStorageDb:
    ...
    def load_storage_state(self):
        ...
        try:
            ...
            print("Firebase data retrieved:", storage_data)
            ...
            if not storage_data:
                ...
                try:
                    with open('./contract_storage.json', 'r') as f:
                        content = f.read()
                        print("Local file content:", content)
            ...
            # Ensure storage_data is valid before iterating
            if not storage_data or not isinstance(storage_data, dict):
                print("No valid data found in Firebase or local file.")
                return {}

            # Step 3: Deserialize symbol tables
