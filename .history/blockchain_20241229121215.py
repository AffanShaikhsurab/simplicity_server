...
class Blockchain:
    ...
    def __init__(self):
        ...
        self.storage = self.storage_db.load_storage_state() or {}
        self.public_address = ""
        self.private_address = ""
        self.ip_address = ""
        self.storage = {} # state storage for smart contract
    ...
    def execute_contract(self , transaction ,  public_address, digital_signature):
        ...
        try:
            ...
            print("contract name is " , state[contract_name] )
            print("symbol table is " , state[contract_name]["symbol_table"])
            if state[contract_name]["symbol_table"] != None:
                contract_symbol_table = state[contract_name]["symbol_table"]
            else:   
    ...
    def new_transaction(self, transaction ,  public_address , digital_signature):
        ...
        if self.valid_transaction(transaction  , public_address , digital_signature) :
            ...
            if 'contract_name' in transaction and 'code' in transaction :
                ...
                self.storage[contract_transaction.contract_name] = {
                    "contract_name": contract_transaction.contract_name,
                    "symbol_table": None
                }
