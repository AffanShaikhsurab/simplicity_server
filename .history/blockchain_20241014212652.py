...
class Blockchain(object):
    ...
    def verify_digital_signature(self, transaction, compressed_public_key, digital_signature_base64):
        try:
            ...
            # Custom JSON encoder to handle PublicKey objects
            class PublicKeyEncoder(json.JSONEncoder):
                def default(self, obj):
                    if isinstance(obj, PublicKey):
                        return obj.toCompressed()  # Convert PublicKey to compressed string representation
                    return super().default(obj)

            # Convert transaction to JSON using the custom encoder
            transaction_json = json.dumps(transaction, cls=PublicKeyEncoder)
            ...
            try:
                ...
                print("digital_signature_base64", digital_signature.toBase64())
            except ValueError as e:
