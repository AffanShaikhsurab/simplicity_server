...
contract_name = "counter"  # The name of the contract to be called
parameters = {"count": 5}  # Example contract parameters (can vary by contract)
...
try:
    ...
    endpoint = "http://127.0.0.1:5000/contracts/call"  # Adjust the port if needed
