...
contract_name = "68e3101635066010a9e4fe3b15faa4c36292c3070b29fd03f1dfa5a4ef161c9f"  # The name of the contract to be called
...
transaction_payload = {
    ...
    "contract_address": contract_name,  # Contract name
