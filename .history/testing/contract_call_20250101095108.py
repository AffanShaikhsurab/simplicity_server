...
contract_address = "5d2b2bc52a05d2c22fa6d0f1f822a25761687132337687e6b2183665253223f3"  # The name of the contract to be called
parameters = {"amount": 1 , "address" : "02e0cd3cc43abbc54dfa39c89d893b84878041b4c81dfa98deef63e09395fe262a"}  # Example contract parameters (can vary by contract)

# Create the transaction payload
transaction_payload = {
    "sender": "02b91a05153e9ba81b55e1ade91241bf17bfdc1b8f553b0aff35636ec6f7f5078a",  # Sender's public key as the address
    "contract_address": contract_address,  # Contract name
